...
template <> constexpr inline auto ClientPage::qt_create_metaobjectdata<qt_meta_tag_ZN10ClientPageE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ClientPage, qt_meta_tag_ZN10ClientPageE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject ClientPage::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ClientPageE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ClientPageE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10ClientPageE_t>.metaTypes,
    nullptr
} };
...
void *ClientPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ClientPageE_t>.strings))
